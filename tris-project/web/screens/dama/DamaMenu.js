...
import styles from './DamaStyles';

/**
 * DamaMenuScreen – Documentazione
 *
 * Questo componente React Native rappresenta il menu iniziale per la modalità "Dama".
 ...
 *
 * Navigazione:
 * - Utilizza la prop navigation per passare a 'GameDama' con i parametri raccolti.
 *
 * Note aggiuntive:
 ...
 *
 * In sintesi:
 * Gestisce la schermata di configurazione iniziale della modalità Dama, raccogliendo i dati dei giocatori e le impostazioni prima di iniziare la partita.
 */

export default function DamaMenuScreen({ navigation }) {
